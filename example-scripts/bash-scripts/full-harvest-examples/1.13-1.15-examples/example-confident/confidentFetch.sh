...
echo "Starting harvest process..."

export HARVESTER_INSTALL_DIR=/home/kampeb/vivo-fid-bau-1-12/confident-harvester/
export HARVEST_NAME=Confident-Harvest
...
echo Execute jsonfetch from Confident.org
harvester-jsonfetch -w DEBUG -X confidentfetch.config.xml
