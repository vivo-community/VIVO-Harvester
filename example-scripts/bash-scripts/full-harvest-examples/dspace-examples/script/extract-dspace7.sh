...
cp $WORKDIR/resources/harvester-dspace7.conf $WORKDIR/resources/harvester-dspace.conf
cp $WORKDIR/resources/harvester-dspace7.conf $WORKDIR/../../../../build/classes/harvester.conf
