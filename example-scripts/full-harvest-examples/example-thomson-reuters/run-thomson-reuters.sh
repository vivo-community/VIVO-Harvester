...
export HARVEST_NAME=example-thomson-reuters
...
# The ThomsonReutersFetch tool in particular takes the data from the chosen source described in its
...
harvester-thomsonreutersfetch -X thomsonreutersfetch.config.xml
