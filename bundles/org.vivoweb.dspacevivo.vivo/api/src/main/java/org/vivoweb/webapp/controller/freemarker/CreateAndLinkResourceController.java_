...
public class CreateAndLinkResourceController extends FreemarkerHttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        // Added by UQAM for DSPACE
        typeToClassMap.put("dspace_repository", "http://vivoweb.org/ontology/dspace#Repository");
        typeToClassMap.put("dspace_item", "http://vivoweb.org/ontology/dspace#Item");
        typeToClassMap.put("dspace_community", "http://vivoweb.org/ontology/dspace#Community");
        typeToClassMap.put("dspace_collection", "http://vivoweb.org/ontology/dspace#Collection");
