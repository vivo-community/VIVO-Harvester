...
public class ArgDef {
	...
	private String desc;
	/**
	 * XPath expression for config file
	 */
	...
	/**
	 * Get the xpath expression for the config value
	 * @return the xpath expression
	 */
	public String getXPath() {
		if(StringUtils.isNotBlank(this.xpath)) {
			return this.xpath;
		}
		String path = "/Config/";
		String more = null;
		if(StringUtils.isNotBlank(more = ""+getLongOption())) {
			path += more;
		} else if(StringUtils.isNotBlank(more = ""+getShortOption())) {
			path += more;
		} else {
			throw new IllegalArgumentException("Cannot get XPath when no path, short option, or long option set!");
		}
		return path;
	}
	...
	/**
	 * Sets the xpath expression for the config value
	 * @param xpath xpath expression
	 * @return this ArgDef
	 */
	public ArgDef setXPath(String xpath) {
		this.xpath = xpath;
		return this;
	}
