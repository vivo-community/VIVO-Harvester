 ...
 *****************************************************************************************************************************/
package org.vivoweb.harvester.cli.util.repo;
...
import org.vivoweb.harvester.cli.util.repo.RecordMetaData.RecordMetaDataType;
...
public class JenaRecordHandler extends RecordHandler {
	...
	public Set<String> find(String idText) throws IOException {
		...
		String query = "" +
			...
			"} ORDER BY ?idField";
		for(QuerySolution record : IterableAide.adapt(this.model.executeSelectQuery(query))) {
