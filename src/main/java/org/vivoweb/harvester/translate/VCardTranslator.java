 ...
 * TITLE Title Specifies the job title, functional position or function of the individual associated with the vCard object within
 * 	an organization (V. P. Research and Development)
 ...
 * AGENT Agent Information about another person who will act on behalf of the vCard object. Typically this would be an area
 * 	administrator, assistant, or secretary for the individual ORG Organization Name The name and optionally the unit(s) of the
 * 	organization associated with the vCard object. This property is based on the X.520 Organization Name attribute and the X.520
 * 	Organization Unit attribute or Organizational unit NOTE Note Specifies supplemental information or a comment that is associated
 * 	with the vCard
 * REV Last Revision Combination of the calendar date and time of day of the last update to the vCard object
 * SOUND Sound By default, if this property is not grouped with other properties it specifies the pronunciation of the Formatted
 * 	Name property of the vCard object.
