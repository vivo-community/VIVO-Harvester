...
/**
 * RDF Tranlator This class translates RDF from its current schema into the VIVO ontology. It uses RDFworkflows to
 * manipulate the data
...
public class RDFTranslator {
	...
	public void processWorkFlow(Model workflow, Model toBeModified) {
		log.debug(workflow + " " + toBeModified);
	...
	public static void main(String... args) {
		InitLog.initLogger(RDFTranslator.class);
