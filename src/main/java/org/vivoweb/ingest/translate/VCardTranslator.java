 ...
 * TITLE Title Specifies the job title, functional position or function of the individual associated with the vCard
 * object within an organization (V. P. Research and Development)
 * ROLE Role or occupation The role, occupation, or business category of the vCard object within an organization (eg.
 * Executive)
 * LOGO Logo An image or graphic of the logo of the organization that is associated with the individual to which the
 * vCard belongs
 * AGENT Agent Information about another person who will act on behalf of the vCard object. Typically this would be an
 * area administrator, assistant, or secretary for the individual
 * ORG Organization Name The name and optionally the unit(s) of the organization associated with the vCard object. This
 * property is based on the X.520 Organization Name attribute and the X.520 Organization Unit attribute
 ...
 * SOUND Sound By default, if this property is not grouped with other properties it specifies the pronunciation of the
 * Formatted Name property of the vCard object.
 * URL URL An URL is a representation of an Internet location that can be used to obtain real-time information about the
 * vCard object
 * UID Unique Identifier Specifies a value that represents a persistent, globally unique identifier associated with the
 * object
