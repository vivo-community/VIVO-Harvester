...
<xsl:stylesheet 
  ...
  <xsl:template match="/">
    <oai_dc xmlns:oai_dc="http://www.openarchives.org/OAI/2.0/oai_dc/" 
      ...
      <!-- dc.bundle -->
      <xsl:for-each select="doc:metadata/doc:element[@name='bundles']/doc:element[@name='bundle']/doc:field[@name='name'][text()='ORIGINAL']/../doc:element[@name='bitstreams']/doc:element[@name='bitstream']/doc:field[@name='url']">
        <dc:bundle>
          <xsl:value-of select="." />
        </dc:bundle>
      </xsl:for-each>
