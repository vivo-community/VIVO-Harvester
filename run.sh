...
# Execute Score
java -cp target/ingest-0.4.jar:target/dependency/* org.vivoweb.ingest.score.Score -i config/recordHandlers/PubmedRDFRecordHandler.xml -v config/jenaModels/VIVO.xml
