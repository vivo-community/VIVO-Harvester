...
# Execute Score
java -cp target/ingest-0.3.jar:target/dependency/* org.vivoweb.ingest.score.Score config/recordHandlers/ScoringInXMLRecordHandler.xml config/jenaModels/ScoringJenaInput.xml config/jenaModels/ScoringVIVOInput.xml config/jenaModels/ScoringJenaOutput.xml 
