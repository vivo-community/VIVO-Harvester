...
java -cp bin/ingest-0.4.0.jar:bin/dependency/* org.vivoweb.ingest.qualify.SPARQLQualify -j config/jenaModels/VIVO.xml -n staging -t PROF -v PROF -d http://vivoweb.org/ontology/core#hrJobTitle 
