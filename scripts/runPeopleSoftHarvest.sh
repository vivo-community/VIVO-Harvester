...
# Execute Fetch
java -Xms1024m -Xmx3072M -cp bin/harvester-$VERSION.jar:bin/dependency/* org.vivoweb.harvester.fetch.JDBCFetch -X config/tasks/PeopleSoftFetch.xml
...
# Execute Translate
java -Xms1024m -Xmx3072M -cp bin/harvester-$VERSION.jar:bin/dependency/* org.vivoweb.harvester.translate.XSLTranslator -i config/recordHandlers/PeopleSoft-XML.xml -o config/recordHandlers/PeopleSoft-RDF.xml -x config/datamaps/PeopleSoftToVivo.xsl
...
java -Xms1024m -Xmx3072M -cp bin/harvester-$VERSION.jar:bin/dependency/* org.vivoweb.harvester.transfer.Transfer -o config/jenaModels/h2.xml -O modelName=peopleSoftTempTransfer -O dbUrl="jdbc:h2:XMLVault/h2ps/all/store;MODE=HSQLDB" -h config/recordHandlers/PeopleSoft-RDF.xml -n http://vivotest.ctrip.ufl.edu/vivo/individual/
...
#java -Xms1024m -Xmx3072M -cp bin/harvester-$VERSION.jar:bin/dependency/* org.vivoweb.harvester.update.ChangeNamespace -i config/jenaModels/h2.xml -I modelName=peopleSoftTempTransfer -I dbUrl="jdbc:h2:XMLVault/h2ps/all/store;MODE=HSQLDB" -v config/jenaModels/VIVO.xml -n http://vivo.ufl.edu/individual/ -o http://vivoweb.org/harvest/peoplesoft/person/ -p http://vivo.ufl.edu/ontology/vivo-ufl/ufid
...
##java -Xms1024m -Xmx3072M -cp bin/harvester-$VERSION.jar:bin/dependency/* org.vivoweb.harvester.update.ChangeNamespace -i config/jenaModels/h2.xml -I modelName=peopleSoftTempTransfer -I dbUrl="jdbc:h2:XMLVault/h2ps/all/store;MODE=HSQLDB" -v config/jenaModels/VIVO.xml -n http://vivo.ufl.edu/individual/ -o http://vivoweb.org/harvest/peoplesoft/address/ -p http://vivoweb.org/ontology/core#mailingAddressFor
# backup H2 change namesace Models
##date=`date +%Y-%m-%d_%k%M.%S`
...
java -Xms1024m -Xmx3072M -cp bin/harvester-$VERSION.jar:bin/dependency/* org.vivoweb.harvester.update.ChangeNamespace -i config/jenaModels/h2.xml -I modelName=peopleSoftTempTransfer -I dbUrl="jdbc:h2:XMLVault/h2ps/all/store;MODE=HSQLDB" -v config/jenaModels/VIVO.xml -n http://vivo.ufl.edu/individual/ -o http://vivoweb.org/harvest/peoplesoft/org/ -p http://vivo.ufl.edu/ontology/vivo-ufl/deptID
# backup H2 change namesace Models
date=`date +%Y-%m-%d_%k%M.%S`
...
java -Xms1024m -Xmx3072M -cp bin/harvester-$VERSION.jar:bin/dependency/* org.vivoweb.harvester.update.ChangeNamespace -i config/jenaModels/h2.xml -I modelName=peopleSoftTempTransfer -I dbUrl="jdbc:h2:XMLVault/h2ps/all/store;MODE=HSQLDB" -v config/jenaModels/VIVO.xml -n http://vivo.ufl.edu/individual/ -o http://vivoweb.org/harvest/peoplesoft/position/ -p http://vivoweb.org/ontology/core#positionInOrganization -p http://vivoweb.org/ontology/core#positionForPerson -p http://vivo.ufl.edu/ontology/vivo-ufl/deptIDofPosition
# backup H2 change namesace Models
date=`date +%Y-%m-%d_%k%M.%S`
