...
# Execute Fetch
java -Xms1024m -Xmx1024M -cp bin/ingest-0.6.0.jar:bin/dependency/* org.vivoweb.ingest.fetch.JDBCFetch -X config/tasks/PeopleSoft-JDBCFetch.xml

# Execute Translate
java -Xms1024m -Xmx1024M -cp bin/ingest-0.6.0.jar:bin/dependency/* org.vivoweb.ingest.translate.XSLTranslator -i config/recordHandlers/PeopleSoft-XML-RH.xml -o config/recordHandlers/PeopleSoft-RDF-RH.xml -x config/datamaps/PeopleSoftToVivo.xsl
...
java -Xms1024m -Xmx1024M -cp bin/ingest-0.6.0.jar:bin/dependency/* org.vivoweb.ingest.transfer.Transfer -r backups/uf.owl.rdf.xml -o config/jenaModels/VIVO.xml
java -Xms1024m -Xmx1024M -cp bin/ingest-0.6.0.jar:bin/dependency/* org.vivoweb.ingest.transfer.Transfer -r backups/ufOrgs.rdf.xml -o config/jenaModels/VIVO.xml

# Execute Transfer from local temp model into main vivo model
java -Xms1024m -Xmx1024M -cp bin/ingest-0.6.0.jar:bin/dependency/* org.vivoweb.ingest.transfer.Transfer -i config/jenaModels/h2.xml -I modelName=peopleSoftTempTransfer -I dbUrl="jdbc:h2:XMLVault/h2all/store;MODE=HSQLDB" -o config/jenaModels/VIVO.xml

# Execute Transfer to copy into peopleSoft model
java -Xms1024m -Xmx1024M -cp bin/ingest-0.6.0.jar:bin/dependency/* org.vivoweb.ingest.transfer.Transfer -i config/jenaModels/h2.xml -I modelName=peopleSoftTempTransfer -I dbUrl="jdbc:h2:XMLVault/h2all/store;MODE=HSQLDB" -o config/jenaModels/VIVO.xml -O modelName=peopleSoft
