...
mysql -u root -pv3nd3tt4 -e 'drop database peopleSoftXML;'
mysql -u root -pv3nd3tt4 -e 'create database peopleSoftXML;'
mysql -u root -pv3nd3tt4 -e 'drop database peopleSoftRDF;'
mysql -u root -pv3nd3tt4 -e 'create database peopleSoftRDF;'
...
#mysqldump -u root -pv3nd3tt4 vitrodb > backups/vitrodb.$date.sql
#rm -rf backups/vitrodb.current.sql
#ln -s vitrodb.$date.sql backups/vitrodb.current.sql
#mysql -u root -pv3nd3tt4 -e 'drop database vitrodb;'
#mysql -u root -pv3nd3tt4 -e 'create database vitrodb;'
#mysql -u root -pv3nd3tt4 vitrodb < backups/blankVivo.sql
...
sleep 20s
/etc/init.d/apache2 restart>>>>>>> .r480
