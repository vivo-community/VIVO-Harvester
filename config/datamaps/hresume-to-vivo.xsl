...
<!-- 
  ...
  hResume to VIVO Translation File
  This file will denote the elements in an hResume file and thier translation into
  the VIVO ontology's schema.  hResume is a microformat found at http://microformats.org/wiki/hresume
  microformats use xhtml to store thier data and are thus transformable using
  xsl.  NOTE hResume is still listed as draft format on the microformats page
